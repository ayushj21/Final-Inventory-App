...
import com.example.ayush_l15fue5.inventoryapp_2.Database.DatabaseContract;
...
//    public int itemQuantity;
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        int idColumnIndex =
                cursor.getColumnIndex(DatabaseContract.DatabaseEntry._ID);
        int nameColumnIndex =
                cursor.getColumnIndex(DatabaseContract.DatabaseEntry.COLUMN_INVENTORY_PRODUCT_NAME);
        int priceColumnIndex =
                cursor.getColumnIndex(DatabaseContract.DatabaseEntry.COLUMN_INVENTORY_PRICE);
        int quantityColumnIndex =
                cursor.getColumnIndex(DatabaseContract.DatabaseEntry.COLUMN_INVENTORY_QUANTITY);
