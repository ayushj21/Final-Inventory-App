...
public class item_editor extends AppCompatActivity
    ...
    private void saveItem() {
        ...
        values.put(DatabaseEntry.COLUMN_INVENTORY_PRODUCT_NAME, nameString);
        values.put(DatabaseEntry.COLUMN_INVENTORY_PRICE, priceString);
        values.put(DatabaseEntry.COLUMN_INVENTORY_QUANTITY, quantityString);
        values.put(DatabaseEntry.COLUMN_INVENTORY_SUPPLIER_NAME, supplierNameString);
        values.put(DatabaseEntry.COLUMN_INVENTORY_SUPPLIER_PHONE, supplierPhoneString);

        // Determine if this is a new or existing item by checking mCurrentItemUri is null or not
        if (mCurrentItemUri == null) {
            // This is a new item
            Uri newUri = getContentResolver().insert(DatabaseEntry.CONTENT_URI, values);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mItemHasChanged) {
                    NavUtils.navigateUpFromSameTask(item_editor.this);
                    return true;
                }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        String[] projection = {
                BaseColumns._ID,
                DatabaseEntry.COLUMN_INVENTORY_PRODUCT_NAME,
                DatabaseEntry.COLUMN_INVENTORY_PRICE,
                DatabaseEntry.COLUMN_INVENTORY_QUANTITY,
                DatabaseEntry.COLUMN_INVENTORY_SUPPLIER_NAME,
                DatabaseEntry.COLUMN_INVENTORY_SUPPLIER_PHONE};
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (data.moveToFirst()) {
            ...
            int idColumnIndex = data.getColumnIndex(DatabaseEntry._ID);
            int nameColumnIndex = data.getColumnIndex(DatabaseEntry.COLUMN_INVENTORY_PRODUCT_NAME);
            int priceColumnIndex = data.getColumnIndex(DatabaseEntry.COLUMN_INVENTORY_PRICE);
            int quantityColumnIndex = data.getColumnIndex(DatabaseEntry.COLUMN_INVENTORY_QUANTITY);
            int supplierNameColumnIndex = data.getColumnIndex(DatabaseEntry.COLUMN_INVENTORY_SUPPLIER_NAME);
            int supplierPhoneColumnIndex = data.getColumnIndex(DatabaseEntry.COLUMN_INVENTORY_SUPPLIER_PHONE);
